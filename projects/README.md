...
|---|---|---|---|
| [Full CI/CD pipeline](./full-cicd-pipeline/README.md) | [Git](../02-git/README.md), [Docker](../03-docker/README.md), [Kubernetes](../04-kubernetes/README.md), [GitHub Actions](../05-github-actions/README.md), [Prometheus](../06-prometheus/README.md) | ~2–4 h | Build an image, apply a Deployment on kind, read a workflow file |
| [Terraform + Ansible + Vault](./terraform-ansible-gitlab-vault/README.md) | [Terraform](../09-terraform/README.md), [Ansible](../08-ansible/README.md) | ~3–5 h (local path ~45 min) | `terraform apply` a local example; run a localhost playbook |
