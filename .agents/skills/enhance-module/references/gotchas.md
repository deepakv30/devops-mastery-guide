...
- **Terraform needs a cloud account.** It does not. Beginner is `local_file` under `05-terraform/examples/local-file/`.
- **Root README lies.** The module table lists only folders that exist. Planned topics go under “Planned, not written yet.”
